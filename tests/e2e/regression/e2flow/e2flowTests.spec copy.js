...
const { createCompany, createRandomCompany, getCompanyData, createCompany22 } = require("../../../../src/api/company");
...
test.describe("E2flow Connector tests", async () => {
    ...
    const filePathE2flowTenant = path.join(process.cwd() + "/testdata/e2net/companies/e2flow-company-create-tenant.json");

    test.beforeAll("E2flow - Setup Company, Connection and Passthrough", async () => {
        ...
        // companyResponseBody = await createRandomCompany(); // fix for tenant tenant as optional
        // companyResponseBody = await createRandomCompany("Tenant");

        // await createRandomCompany(); // should create random tenant company
        // await createRandomCompany("Tenant"); // should create random tenant company
        // await createRandomCompany("Partner"); // should create random Partner company
        // await createRandomCompany("Network"); // should create random Network company

        // await createCompany22(); // If you not give Payload > should create random tenant company
        // await createCompany22("Tenant"); // should create random tenant company > call createRandomCompany
        // await createCompany22("Partner"); // should create random Partner company > call createRandomCompany
        // await createCompany22("Network"); // should create random Network  > createRandomCompany
        const fileContent = await readFile(filePathE2flowTenant);
        const payload = await JSON.parse(fileContent);
        await createCompany(payload); // should create random tenant company
        // await createCompany(companyRequestBody); // should create random Partner company
        // await createCompany(companyRequestBody); // should create random Network company
