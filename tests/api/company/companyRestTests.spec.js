...
const { urlBuilder } = require("../../../src/utils/apiCommon/urlBuilder");
// const {APIUtils} = require('../../../src/utils/apiCommon/APIUtils');

let id;
const randomString = Math.random().toString(36).substring(2, 10);

test.describe("Create Company and Search", async () => {
    const initialPayload = {
        org: {
            companyTypeName: "Tenant",
            name: "CentOSSen",
            companyId: "CentOSSen",
            communityUniqueID: "CentOSSen.com",
    ...
    const url = urlBuilder.buildUrl.companyEndPointUrl;
});
...
test.only("should be able to get the unique connection", async ({ request }) => {
